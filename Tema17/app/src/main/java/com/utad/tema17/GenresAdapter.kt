...
interface GenreClickedListener {
    fun onGenreClicked(genre: GenresResponse.Genre)
}

class GenresAdapter(
    private val data: ArrayList<GenresResponse.Genre>,
    private val genreClickedListener: GenreClickedListener
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            genreClickedListener.onGenreClicked(genre)
        }
    }
